...
namespace RealisticPopulationRevisited
{
    ...
    internal static class PopData
    {
        ...
        internal static void Setup()
        {
            ...
            resLow.levels[0] = new LevelData { floorHeight = 3f, areaPer = -1, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = true };
            resLow.levels[1] = new LevelData { floorHeight = 3f, areaPer = -1, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = true };
            resLow.levels[2] = new LevelData { floorHeight = 3f, areaPer = -1, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = true };
            resLow.levels[3] = new LevelData { floorHeight = 3f, areaPer = -1, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = true };
            resLow.levels[4] = new LevelData { floorHeight = 3f, areaPer = -1, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = true };
            ...
            resMed.levels[0] = new LevelData { floorHeight = 3f, areaPer = 140, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = false };
            resMed.levels[1] = new LevelData { floorHeight = 3f, areaPer = 145, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = false };
            resMed.levels[2] = new LevelData { floorHeight = 3f, areaPer = 150, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = false };
            resMed.levels[3] = new LevelData { floorHeight = 3f, areaPer = 160, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = false };
            resMed.levels[4] = new LevelData { floorHeight = 3f, areaPer = 170, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            resHigh.levels[0] = new LevelData { floorHeight = 3f, areaPer = 140, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = true, multiFloorUnits = false };
            resHigh.levels[1] = new LevelData { floorHeight = 3f, areaPer = 145, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = true, multiFloorUnits = false };
            resHigh.levels[2] = new LevelData { floorHeight = 3f, areaPer = 150, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = true, multiFloorUnits = false };
            resHigh.levels[3] = new LevelData { floorHeight = 3f, areaPer = 160, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = true, multiFloorUnits = false };
            resHigh.levels[4] = new LevelData { floorHeight = 3f, areaPer = 170, firstFloorMin = 3f, firstFloorExtra = 0f, firstFloorEmpty = true, multiFloorUnits = false };
            ...
            comLow.levels[0] = new LevelData { floorHeight = 3f, areaPer = 40, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            comLow.levels[1] = new LevelData { floorHeight = 3f, areaPer = 40, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            comLow.levels[2] = new LevelData { floorHeight = 3f, areaPer = 40, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            ...
            comHigh.levels[0] = new LevelData { floorHeight = 4f, areaPer = 23, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = false };
            comHigh.levels[1] = new LevelData { floorHeight = 4f, areaPer = 23, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = false };
            comHigh.levels[2] = new LevelData { floorHeight = 4f, areaPer = 23, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            retailWarehouse.levels[0] = new LevelData { floorHeight = 12f, areaPer = 108, firstFloorMin = 3f, firstFloorExtra = 9f, firstFloorEmpty = false, multiFloorUnits = false };
            retailWarehouse.levels[1] = new LevelData { floorHeight = 12f, areaPer = 108, firstFloorMin = 3f, firstFloorExtra = 9f, firstFloorEmpty = false, multiFloorUnits = false };
            retailWarehouse.levels[2] = new LevelData { floorHeight = 12f, areaPer = 108, firstFloorMin = 3f, firstFloorExtra = 9f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            hotel.levels[0] = new LevelData { floorHeight = 4f, areaPer = 130, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            hotel.levels[1] = new LevelData { floorHeight = 4f, areaPer = 130, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            hotel.levels[2] = new LevelData { floorHeight = 4f, areaPer = 130, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            calcPacks.Add(hotel);
            ...
            restaurant.levels[0] = new LevelData { floorHeight = 4f, areaPer = 22, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = true };
            restaurant.levels[1] = new LevelData { floorHeight = 4f, areaPer = 22, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = true };
            restaurant.levels[2] = new LevelData { floorHeight = 4f, areaPer = 22, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = true };
            ...
            entertainment.levels[0] = new LevelData { floorHeight = 6f, areaPer = 108, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            entertainment.levels[1] = new LevelData { floorHeight = 6f, areaPer = 108, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            entertainment.levels[2] = new LevelData { floorHeight = 6f, areaPer = 108, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = false, multiFloorUnits = true };
            ...
            lightIndustry.levels[0] = new LevelData { floorHeight = 4f, areaPer = 47, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            lightIndustry.levels[1] = new LevelData { floorHeight = 4f, areaPer = 47, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            lightIndustry.levels[2] = new LevelData { floorHeight = 4f, areaPer = 47, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            indFactory.levels[0] = new LevelData { floorHeight = 4f, areaPer = 36, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            indFactory.levels[1] = new LevelData { floorHeight = 4f, areaPer = 36, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            indFactory.levels[2] = new LevelData { floorHeight = 4f, areaPer = 36, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            indWarehouse.levels[0] = new LevelData { floorHeight = 9f, areaPer = 70, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            indWarehouse.levels[1] = new LevelData { floorHeight = 9f, areaPer = 70, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            indWarehouse.levels[2] = new LevelData { floorHeight = 9f, areaPer = 70, firstFloorMin = 3f, firstFloorExtra = 6f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            highBay.levels[0] = new LevelData { floorHeight = 12f, areaPer = 80, firstFloorMin = 3f, firstFloorExtra = 9f, firstFloorEmpty = false, multiFloorUnits = false };
            highBay.levels[1] = new LevelData { floorHeight = 12f, areaPer = 80, firstFloorMin = 3f, firstFloorExtra = 9f, firstFloorEmpty = false, multiFloorUnits = false };
            highBay.levels[2] = new LevelData { floorHeight = 12f, areaPer = 80, firstFloorMin = 3f, firstFloorExtra = 9f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            offLow.levels[0] = new LevelData { floorHeight = 4f, areaPer = 34, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            offLow.levels[1] = new LevelData { floorHeight = 4f, areaPer = 36, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            offLow.levels[2] = new LevelData { floorHeight = 4f, areaPer = 38, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            offHigh.levels[0] = new LevelData { floorHeight = 4f, areaPer = 25, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = true, multiFloorUnits = false };
            offHigh.levels[1] = new LevelData { floorHeight = 4f, areaPer = 25, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = true, multiFloorUnits = false };
            offHigh.levels[2] = new LevelData { floorHeight = 4f, areaPer = 25, firstFloorMin = 3f, firstFloorExtra = 3f, firstFloorEmpty = true, multiFloorUnits = false };
            ...
            suburbanSchool.levels[0] = new LevelData { floorHeight = 4f, areaPer = 8, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            suburbanSchool.levels[1] = new LevelData { floorHeight = 4f, areaPer = 8, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            ...
            mnLow.levels[0] = new LevelData { floorHeight = 4f, areaPer = 14, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            mnLow.levels[1] = new LevelData { floorHeight = 4f, areaPer = 30, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            calcPacks.Add(mnLow);
            ...
            mnMed.levels[0] = new LevelData { floorHeight = 4f, areaPer = 12, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            mnMed.levels[1] = new LevelData { floorHeight = 4f, areaPer = 23, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            calcPacks.Add(mnMed);
            ...
            mnHigh.levels[0] = new LevelData { floorHeight = 4f, areaPer = 9, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
            mnHigh.levels[1] = new LevelData { floorHeight = 4f, areaPer = 14, firstFloorMin = 3f, firstFloorExtra = 1f, firstFloorEmpty = false, multiFloorUnits = false };
