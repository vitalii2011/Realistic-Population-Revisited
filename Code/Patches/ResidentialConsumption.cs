...
{
    /// <summary>
    /// Harmony patch to implement residential building consumption rates.
    /// </summary>
    [HarmonyPatch(typeof(ResidentialBuildingAI), nameof(ResidentialBuildingAI.GetConsumptionRates))]
