...
{
    /// <summary>
    /// Harmony patch to implement extractor building consumption rates.
    /// </summary>
    [HarmonyPatch(typeof(IndustrialExtractorAI), nameof(IndustrialExtractorAI.GetConsumptionRates))]
