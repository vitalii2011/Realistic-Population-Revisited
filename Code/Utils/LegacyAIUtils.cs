...
namespace RealPop2
{
    internal class LegacyAIUtils
    {
        ...
        internal static void RemoveHouseHold(ref Building data, int maxHomes)
        {
            ...
            CitizenUnit[] citizenUnitArray = citizenManager.m_units.m_buffer;
            ...
            while (currentUnit != 0u)
            {
                ...
                if (removeCurrentUnit)
                {
                    ...
                    ReversePatches.ReleaseUnitImplementation(citizenManager, currentUnit, ref citizenUnitArray[currentUnit]);
